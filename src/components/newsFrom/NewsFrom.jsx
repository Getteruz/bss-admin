...
import { GetNewsbyid, UpdateNews } from '../../shared/api/news';
...
export default function NewsFrom() {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            const data = await GetNewsbyid(param?.id);
    ...
    const HandleAddWebsite = async (data) => {
        ...
        if (data) {
            ...
            await UpdateNews({ img: img1, ...data }, param?.id)
                .then((response) => {
    ...
    return (
        ...
        <form className='ServicesFrom'>
            ...
            <div className="ServicesFrom_top">
                <div className='ServicesFrom_top-back'><Link className='ServicesFrom_top-back2' to={routes.NEWS}>Добавление новости</Link></div>
            ...
            <div className="ServicesFrom_from" >
                ...
                <div className='ServicesFrom_from-mid mid2'>
                    ...
                    <div className='ServicesFrom_from-mid-left'>
                        <textarea className='ServicesFrom_from-mid-inputtitle inputtitle2' type="text" placeholder='Название' onClick={(e) => e.target.classList.add("inputtagcolor")} {
